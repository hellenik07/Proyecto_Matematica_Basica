...
def mostrar_tutor():
    ...
    <style>
        ...
        /* ── HEADER SIEMPRE VISIBLE Y ESTÁTICO ── */
    ...
    # ══════════════════════════════
    # HEADER (Ultra-compacto, Estático y a la Izquierda)
    # ══════════════════════════════
    # Añadimos una columna vacía al final (c_vacio) para empujar los botones hacia la izquierda
    c_logo, c_m, c_f, c_n, c_reset, c_vacio = st.columns([2.5, 1.2, 1.2, 1.2, 1.2, 4])
    with c_logo:
