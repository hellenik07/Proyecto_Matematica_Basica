    ...
    2: [
        {
            ...
            "pasos": [
                ...
                },
                {
                    ...
                    "pregunta": " ¿Cómo quedan los ceros?",
                    "opciones": {
                        "A": "x = 2 y x = 4",
                        "B": "x = −2 y x = −4",
                        "C": "x = 2 y x = 4"
                ...
                },
                {
                    ...
                    "pregunta": "¿Cual es el intervalo solución?",
                    "opciones": {
                        "A": "S: x ∈ ]−∞, 2[ ∪ ]4, +∞[",
                        "B": "S: x ∈ [2, 4]",
                        "C": "S: x ∈ ]2, 4["
                    ...
                    "correcta": "C",
                    "ok":  "Corchetes abiertos perfectos. ¡Nivel completado!",
            ...
            "pasos": [
                {
                    ...
                    "correcta": "B",
                    "ok": "Cálculo frío y preciso. Multiplicaste el -1 por cada término para extraer el negativo de x² , y el signo se invirtió a >.",
                    "err": "Al factorizar con un coeficiente negativo, el signo de la desigualdad se invierte (de < a >) y el −x se convierte en +x, mientras que el +6 se convierte en −6.",
                },
                {
                    "num": 2,
                    ...
                    "correcta": "C",
                    "ok": "Al despejar x-2=0 pasa la x y queda x=2 positivo y x + 3=0 pasa la x y queda x=-3.",
                    "err": "Intentalo otra vez, revisa los signos al despejar cada factor",
                },
                {
                    "num": 3,
                    "descripcion": "Fase 3: El Territorio Exterior",
                    "expresion_dinamica": r"\text{Ceros: } x = -3 \text{ y } x = 2",
                    ...
                    "correcta": "A",
                    "ok": "Épico. Las dos zonas exteriores perfectas.",
                    "err": "Revisa otra vez tu tabla de signos",
                },
            ],
        },
    ],
    ...
    3: [
        {
            ...
            "pasos": [
                ...
                },
                {
                    ...
                    "pregunta": "Al multiplicar 4 por (x+2) y −5 por (x−3), ¿qué queda en el numerador?",
            ...
            "pasos": [
                {
                    ...
                    "opciones": {
                        ...
                        "C": "Pasar TODO el bloque derecho sumando y armar el MCM"
                    },
                    "correcta": "C",
                    "ok": "Esquivaste la trampa. Pasar el bloque sumando es el movimiento correcto.",
                    "err": "Multiplicar cruzado en inecuaciones es trampa mortal.",
                },
                {
                    "num": 2,
                    ...
                    "pregunta": "Arriba quedó x²+2x−8. Factoriza por inspeccion, ¿que queda?",
                    "opciones": {
                        "A": "(x+4)(x−2)",
                        "B": "(x+8)(x−1)",
                        "C": "(x−4)(x+2)"
